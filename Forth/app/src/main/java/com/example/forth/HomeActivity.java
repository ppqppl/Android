...
import com.example.forth.databinding.ActivityHomeBinding;
...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        weatherurl = findViewById(R.id.weatherimgbtn);
...
//                        showToast("获取实时天气 ：失败！");
                    ...
                    public void onSuccess(WeatherNowBean weatherNowBean) {
                        ...
                        if(Code.OK == weatherNowBean.getCode()){
                            ...
                            txt_temp.setText(temp[0]+"℃"+"（体感温度："+temp[1]+"℃）");
//                            weatherurl.setImageURI(Uri.parse("@drawable/wea"+iconcode));
                        }
                        else {
//                            showToast("解析天气错误!");
