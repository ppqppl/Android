...
//                    imageLink="https://c-ssl.duitang.com/uploads/blog/201506/06/20150606181240_s2rMJ.jpeg";
                    imageLink="https://images.cnblogs.com/cnblogs_com/blogs/746187/galleries/2160861/o_220514152629_ffa0d3bf409e4772b65770e2da474f95.jpeg";
                    setDownBitmap(imageLink,Activity_work6.this);
                }
    ...
    public void onProgressChanged(SeekBar seekBar, int i, boolean b){
        ...
        if (seekBar.getId() == R.id.power1) {
            ...
            suo.setText("缩放倍数为:" + i + "%");
            Log.e("图片尺寸", String.valueOf(newWidth)+"       "+String.valueOf(newHeight));
